"""
Update Checker Dialog for Whitebox AI Agent
...
GITHUB_REPO = "opengeos/qgis-whitebox-agent"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "whitebox_agent"
...
if not METADATA_URL.startswith("https://"):
    raise RuntimeError("METADATA_URL must use https")
if not ZIP_URL.startswith("https://"):
    raise RuntimeError("ZIP_URL must use https")
...
class VersionCheckWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            ) as response:  # nosec B310 - METADATA_URL is the hardcoded https constant asserted at module load
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="whitebox_agent_update_")
            ...
            )  # nosec B310 - ZIP_URL is the hardcoded https constant asserted at module load
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "whitebox_agent.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "whitebox_agent.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Whitebox AI Agent Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Whitebox AI Agent Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Whitebox AI Agent has been updated to version {self.latest_version}.\n\n"
